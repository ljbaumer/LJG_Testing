...
1. **Run relevant tests**: `uv run pytest tests/test_[module].py`
2. **For changes affecting multiple files**: `uv run pytest`
3. **Always mention which tests you ran** in your response
